			...
			<div class="top_box">
				<div class="top_box_inner">
					...
					<div class="menu_box" id="menu"><ul>
						<li id="menuItem0"></li>
						<li class="menu_style" id="menuItem7" name="MenuItem" onclick="showx(7)">我的课程</li>
						<li class="menu_style" id="menuItem8" name="MenuItem" onclick="showx(8)">我的活动</li>
						<li class="menu_style" id="menuItem9" name="MenuItem" onclick="showx(9)">签批活动</li>
					</ul></div>
				</div>
