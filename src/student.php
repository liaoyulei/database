			...
			<div class="top_box">
				<div class="top_box_inner">
					...
					<div class="menu_box" id="menu"><ul>
						<li id="menuItem0"></li>
						<li class="menu_style" id="menuItem1" name="MenuItem" onclick="showx(1)">选择课程</li>
						<li class="menu_style" id="menuItem2" name="MenuItem" onclick="showx(2)">退选课程</li>
						<li class="menu_style" id="menuItem3" name="MenuItem" onclick="showx(3)">我的课程</li>
						<li class="menu_style" id="menuItem4" name="MenuItem" onclick="showx(4)">选择活动</li>
						<li class="menu_style" id="menuItem5" name="MenuItem" onclick="showx(5)">我的活动</li>
						<li class="menu_style" id="menuItem6" name="MenuItem" onclick="showx(6)">申请活动</li>
					</ul></div>
				</div>
